...
public class Db3UserManager implements Db3UserService {
    ...
    public DataResult<UserGetDto> get(String identityNumber) {
        ...
        try {
            user = this.db3UserRepository.getByIdentityNumber(identityNumber);
    ...
    public DataResult<List<UserGetDto>> getAll() {
        ...
        try {
            userList = this.db3UserRepository.findAll();
    ...
    public Result delete(String identityNumber) {
        ...
        try {
            value = this.db3UserRepository.getByIdentityNumber(identityNumber);

            if (value.getIdentityNumber() == null) {
                throw new Exception();
            } else {
                this.db3UserRepository.delete(value);
